          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2 px-4 mt-6 md:mt-0">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:justify-start gap-4 mt-6">
                <a
                  href="www.linkedin.com/in/abhishekware-8a6b89139"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <div
                  className="px-8 py-3 bg-zinc-900 hover:bg-blue-600 border-[2px] text-white border-zinc-300 font-lighter rounded-full cursor-pointer"
                  onClick={handleExploreClick}
                >
                  Explore me
                </div>
